...
public final class ConfigUtils {
    ...
    /**
     * Consumes/Removes a optional int value from a Map with the given key.
     *
     * @param properties
     * @param key
     * @param defaultValue
    ...
    /**
     * Consumes/Removes a optional long value from a Map with the given key.
     *
     * @param properties
     * @param key
     * @param defaultValue
     ...
     */
    @Nullable
    public static Long consumeOptionalLong(Map<String, Object> properties,
                                           String key,
                                           Long defaultValue) {
    ...
    /**
     * Consumes/Removes a optional string value from a Map with the given key.
     *
     * @param properties
     * @param key
     * @param defaultValue
